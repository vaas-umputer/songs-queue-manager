...
std::vector<int> generateRandom(int size = 50)
{
...
{
    srand(time(0));
    std::string filePath = "F:\\LARGER THE SIZE, STEEPER THE CURVE\\CPP\\MUSIC PLAYER\\songs.json";
    ...
    */
    ...
    srand(time(0));
    std::vector<int> indices = generateRandom();
